 ...
 <html>
  ...
  <body>
   ...
   <section>
    ...
    <h3 class="juventude">Juventude</h3>
    ...
    <h3 class="vida-adulta">Vida adulta</h3>
  ...
  <nav>
   <ul>
    <li> <a href="https://pt.wikipedia.org/wiki/Grace_Hopper" target="_blank"> GraceHopper</a> </li>
    <li> <a href="https://pt.wikipedia.org/wiki/Dorothy_Vaughan" target="_blank">Dorothy Vaughan</a> </li>
    <li> <a href="https://pt.wikipedia.org/wiki/Margaret_Hamilton" target="_blank">Margaret Hamilton</a> </li>
